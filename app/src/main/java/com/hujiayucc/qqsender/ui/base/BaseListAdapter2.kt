...
class BaseListAdapter2(
    val memberList: List<MemberBean>,
) : BaseAdapter() {
    override fun getCount(): Int {
        return memberList.size
    }

    override fun getItem(position: Int): MemberBean {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        qqId.text = info.qq.toString()
        checkBox.isChecked = info.check
        Picasso.with(context).load(info.member.avatarUrl)
